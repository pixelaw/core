...
// impl RTreeNode {
//     fn new_leaf(bounding_box: Box) -> RTreeNode {
//         RTreeNode {
//             is_leaf: true,
//             bounding_box,
//             children: Array::new(),
...
//     fn new_internal(bounding_box: Box) -> RTreeNode {
//         RTreeNode {
//             is_leaf: false,
//             bounding_box,
//             children: Array::new(),
...
//     fn update_bounding_box(self: @mut RTreeNode) {
...
//     fn insert(self: @mut RTreeNode, Box: Box) {
//         if self.is_leaf {
//             let new_node = RTreeNode::new_leaf(Box);
...
//     fn search(self: @RTreeNode, px: u32, py: u32) -> bool {
